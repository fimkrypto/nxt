...
public class NxtProperties {
  ...
  static void setup() {
    ...
    Properties properties = loadProperties(new String[] {
        System.getProperty("user.home")
            + "/git/nxt/conf/nxt-default.properties",
        System.getProperty("user.home") + "/git/nxt/conf/nxt.properties",
    });
    ...
    try {
      Properties loggingProperties = loadProperties(new String[] { System
          .getProperty("user.home") + "/git/nxt/conf/logging.properties" });
  ...
  static void debugDump(String title, Properties properties) {
    ...
    sb.append("\n========================================================");
    sb.append("\nNXT Configuration Settings - " + title);
    sb.append("\n========================================================");
