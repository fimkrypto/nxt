  ...
  public JSONStreamAware call(JSONObject arguments) throws ParameterException {
        ...
        try {
            ...
            try (
                ...
                try {
                    System.out.println("Start getAllUnconfirmedTransactions");
                    ...
                    System.out.println("Start getRecentTransactions");
            ...
            System.out.println("unconfirmed_transactions = " + unconfirmed_transactions.size());
            System.out.println("confirmed_transactions = " + confirmed_transactions.size());
